...
get_ipython().system('pip install kagglehub pandas')
import kagglehub
import numpy as np
import pandas as pd
import os
...
st.title("""
:white[Premier League Dashboard]
""")
...
##create a functional season_end_year that can be used to get the season for the yeaer
#get all the unique season years
